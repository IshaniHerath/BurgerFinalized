...
import com.my.springboot.model.Order;
...
//	private static final String SQL1 = "select * from b_orders where cname = 'ish'"; //set the query
	...
	private static final String SQL2 = "INSERT INTO b_orders (id, name, price, qty, total, pType) VALUES (:id, :name ,:price, :qty, :total, :pType)";
	...
	public Burger saveBurger(Burger burger) {
		...
		SqlParameterSource parameters = new MapSqlParameterSource()
				...
				.addValue("pType", burger.getpType());
...
//			customer.setCname((String) row.get("cname"));
			...
			burger.setpType((String) row.get("pType"));
			burgers.add(burger);
		}
		return burgers;
	}
